        ...
        <section class="section-register--right">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-3">
                    ...
                    <input type="text" class="form-control u-box-shadow-1 @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus/>
                    @error('name')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input type="email" class="form-control u-box-shadow-1 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" />
                    @error('email')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="mt-3">
                    ...
                    <input
                        type="password" class="form-control u-box-shadow-1" name="password_confirmation" required autocomplete="new-password"
                    />
                </div>
                <div class="mt-5">
